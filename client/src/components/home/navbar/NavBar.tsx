    ...
    <div className='fixed top-0 left-0 right-0 h-[114px] lg:h-[158px] flex flex-col'>
      <div className='flex-1 flex flex-col'>
        <div className='h-12 bg-[#0a0927]'>
          <div className='h-full flex flex-row items-center justify-end lg:justify-between'>
            <Link
              to='/'
            ...
            <div className='mr-6 flex flex-row items-center '>
              {!user ? (
                ...
                <div className='flex flex-row items-center'>
                  <div
                    className='text-[10px] px-2 rounded-full text-white font-bold'
                    style={{
                      backgroundImage: "linear-gradient(90deg,#79643e,#ae915b)",
                    }}
                  >
                    UPGRADE TO PREMIUM
                  </div>
                  <Link
                    to='/profile'
                    className='text-sm px-2 text-white font-bold hover:underline'
                  >
                    Hi,{user?.firstName != "" ? user.firstName : "Culer"}
                  </Link>
                  <div className='p-2 mx-2 rounded-full bg-[#ffffff1f] hover:bg-[#cd122d] duration-200 ease-in cursor-pointer	'>
                    <svg
                      className='w-[22px] h-[22px] '
                      fill='#fff'
                      aria-hidden='true'
                    ...
                    >
                      <path
                        d='M17.556 19.343a5.276 5.276 0 01-.791-4.429l.98-3.656a5.172 5.172 0 00-2.26-5.72c.185-.198.33-.444.405-.724a1.706 1.706 0 00-1.205-2.087 1.706 1.706 0 00-2.099 2.034A5.172 5.172 0 007.77 8.585l-.98 3.657a5.275 5.275 0 01-2.9 3.439.884.884 0 00-.519.891c.034.38.293.693.662.791l4.73 1.268a2.87 2.87 0 002.118 2.954 2.87 2.87 0 003.31-1.5l2.408.646a.888.888 0 00.969-.355.9.9 0 00-.012-1.033zM14.391 3.81a.578.578 0 11-.3 1.119.578.578 0 11.3-1.119zm-3.226 16.684a1.747 1.747 0 01-1.286-1.568l3.187.854a1.747 1.747 0 01-1.901.714z'
                        fill-rule='evenodd'
                      ></path>
                    </svg>
                  </div>
              ...
              <div className='p-2 mx-4 rounded-full bg-[#ffffff1f] hover:bg-[#cd122d] duration-200 ease-in cursor-pointer	'>
                <p className='text-sm text-white font-semibold'>EN</p>
              </div>
            </div>
          </div>
        </div>
